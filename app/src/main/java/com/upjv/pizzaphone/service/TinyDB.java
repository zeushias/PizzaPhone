...
public class TinyDB {
    ...
    public ArrayList<Pizzas> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Pizzas> playerList =  new ArrayList<Pizzas>();

        for(String jObjString : objStrings){
            Pizzas player  = gson.fromJson(jObjString,  Pizzas.class);
    ...
    public void putListObject(String key, ArrayList<Pizzas> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Pizzas player: playerList){
